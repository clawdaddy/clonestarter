...
class Splash extends Component {
  constructor() {
    ...
    this.state = {
      ...
      bigQuote: {
        quote:
          '"Projects have a life of their own. You make something, but it\'ll tell you what it is."',
        title: "PHOTOGRAPHER & DIRECTOR",
        name: "OLIVIA BEE",
        link:
          "https://thecreativeindependent.com/people/olivia-bee-on-finding-the-right-balance/?ref=ksr_home"
      }
    };
  }
  componentDidMount() {
  ...
  render() {
    ...
    return (
      <div>
        ...
        <Stats />
        <ProjectsPreview />
        <ProjectsWeLove projects={projects} />
